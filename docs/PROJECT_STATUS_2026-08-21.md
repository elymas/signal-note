...
| Facebook Reels 인벤토리 | 재감사 완료 | 12개 출처 5,555편, Trade with Pat 60편 추가 |
| Facebook Reels 분석 | 완료 | 5,552 / 5,555편, 대기 0편, 보류 3편 |
...
| **합계** | **5,552** | **5,555** | **99.9%** | **0** | **+684** |

상세 절차와 ID 무결성 결과는 [`docs/reels/authenticated-inventory-audit-2026-08-23.md`](reels/authenticated-inventory-audit-2026-08-23.md)를 기준으로 한다. 2026-08-23 Trade with Pat 60편은 Aside 탭 확인과 메타데이터·캡션 대조 후 콘텐츠화했고, 메타데이터가 제한된 5편은 캡션을 확인해 보완했다. 기존 보류 3편은 유지했다.
...
`주식해서한강뷰삼촌` 채널 헤더 91편과 공개 목록 90편의 차이 1편은 계속 미확인 상태다. 로그인·연령·멤버십·지역 제한으로 불완전하게 분석된 공개 YouTube 영상은 0편이다.

## 반영 파일

- `research/reels-inventory/facebook-login-2026-08-21.json`: 12개 출처 5,555개 ID
...
- `src/research-constants.js`: 공개 사이트 릴스 인벤토리 5,555편·감사일 2026-08-23
